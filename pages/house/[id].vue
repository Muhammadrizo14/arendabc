<template>
  <div class="h-full bg-brand-bright">
    <offer>
      <div
        class="flex justify-between flex-col md:flex-row md:items-center py-6 md:py-16"
      >
        <div>
          <h3 class="font-bold text-base md:text-xl">
            [ОБЪЕКТ/БЦ/ТРЦ/ТЦ/ОФИС/ОСЗ]
          </h3>
          <h2 class="text-white font-black text-xl md:text-2xl">
            ПРОДАЖА ТЦ НА ПУЛКОВСКОМ ШОССЕ
          </h2>
        </div>
        <div class="flex gap-2 items-center pt-3 md:pt-0 justify-between">
          <button
        ...
        <div class="flex flex-col items-center w-2/2 md:w-3/5">
          ...
          >
            ...
            >
              ...
              электроснабжение мощностью 1000 кВт, теплоснабжение от собственной
              котельной мощностью 268 кВт, а также водопровод и канализацию
              объемом 54,24 кубических метра. Этот объект идеально подходит для
              организации крупного торгового центра или логистического
              комплекса, благодаря своей площади и удобному расположению.
            </p>

            <p
              class="text-brand-blue font-medium cursor-pointer block md:hidden"
              @click="hideInfo = !hideInfo"
            >
              {{ hideInfo ? "Подробнее" : "Скрыть" }}
            </p>
        ...
        <div class="flex flex-col-reverse md:flex-col w-2/2 md:w-2/5">
          ...
          <div class="flex flex-col gap-5 pt-4">
            <div class="py-6 px-3 bg-white border rounded-lg">
              ...
              <div class="flex items-center justify-between">
                <p class="font-medium">5,381,516 ₽</p>
                <p class="text-brand-grey">в месяц</p>
              </div>
              <div class="flex items-center justify-between">
                <p class="font-medium">64,578,192 ₽</p>
            ...
            <div class="py-6 px-3 bg-white border rounded-lg">
              ...
              <div class="flex items-center gap-8 pt-3">
                ...
                <div class="flex w-2/3">
                  <p
                    class="text-brand-grey truncate"
                    :class="phone ? 'w-auto' : 'w-20'"
                  >
                    +7(999) 999 999 999
                  </p>
                  <p
              ...
              <div class="flex items-center gap-8">
                <div class="flex items-center gap-2 w-1/3">
                  ...
                  <p class="font-medium">ЭЛ.ПОЧТА</p>
                </div>
                <div class="flex w-2/3">
                  <p
                    class="text-brand-grey truncate"
                    :class="email ? 'w-auto' : 'w-20'"
                  >
                    INFO@ARENDABC.COM
                  </p>
                  <p
            ...
            <div class="py-6 px-3 bg-white border rounded-lg">
              ...
              <div class="flex items-center gap-8 pt-3">
                <div class="flex items-center gap-2 w-1/2">
                  <img src="/public/img/icons/work.svg" alt="" />

                  <p class="font-medium">УСН</p>
                </div>
      ...
      <div class="container">
        ...
        >
          <div class="flex items-center justify-between pb-3">
            <h3 class="text-brand-grey font-extrabold">
              НАЙДЕНО <span>45 ПОХОЖИХ ОБЪЕКТОВ</span>
            </h3>

  ...
  <div>
    ...
    <section class="stats bg-brand-bright">
      <div class="container flex items-center justify-between py-2">
        ...
        <multiselect class="light" v-if="activeTab === 0" v-model="value" :options="options" :allowEmpty="false" :searchable="false"
                     :show-labels="false" :preselectFirst="true"
                     placeholder="Сортировка"></multiselect>
        <button @click="activeTab === 1 ? activeTab = 0 : activeTab = 1" class="bg-white p-2 rounded-lg">
